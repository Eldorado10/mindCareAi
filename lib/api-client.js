...
export async function createPsychiatrist(data) {
  try {
    ...
    if (!response.ok) throw new Error('Failed to create psychiatrist');
    return await response.json();
  } catch (error) {
...
export async function updatePsychiatrist(id, data) {
  try {
    ...
    if (!response.ok) throw new Error('Failed to update psychiatrist');
    return await response.json();
  } catch (error) {
...
export async function deletePsychiatrist(id) {
  try {
    ...
    if (!response.ok) throw new Error('Failed to delete psychiatrist');
    return await response.json();
  } catch (error) {
